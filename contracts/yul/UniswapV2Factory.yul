...
object "UniswapV2Factory_195" {
    code {
        /// @src 1:101,1922
        mstore(64, 128)
        if callvalue() { revert_error_ca66f745a3ce8ff40e2ccaf1ad45db7774001b90d25810abd9040049be7bf4bb() }

        constructor_UniswapV2Factory_195()

        let _1 := allocate_unbounded()
        codecopy(_1, dataoffset("UniswapV2Factory_195_deployed"), datasize("UniswapV2Factory_195_deployed"))

        return(_1, datasize("UniswapV2Factory_195_deployed"))
        ...
        function constructor_IUniswapV2Factory_1305() {

            /// @src 6:26,660

        }

        function constructor_UniswapV2Factory_195() {

            /// @src 1:444,510
            constructor_IUniswapV2Factory_1305()

            /// @src 1:497,502
            let expr_28 := 0x0123
            /// @src 1:489,503
            let expr_29 := convert_t_rational_291_by_1_to_t_address(expr_28)
            /// @src 1:475,503
            update_storage_value_offset_0t_address_to_t_address(0x01, expr_29)
            let expr_30 := expr_29
