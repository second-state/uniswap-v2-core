...
object "UniswapV2Pair_1046" {
    code {
        /// @src 1:289,9957
        mstore(64, 128)
        if callvalue() { revert_error_ca66f745a3ce8ff40e2ccaf1ad45db7774001b90d25810abd9040049be7bf4bb() }

        constructor_UniswapV2Pair_1046()

        let _1 := allocate_unbounded()
        codecopy(_1, dataoffset("UniswapV2Pair_1046_deployed"), datasize("UniswapV2Pair_1046_deployed"))

        return(_1, datasize("UniswapV2Pair_1046_deployed"))
        ...
        function constructor_IUniswapV2ERC20_1964() {
            ...
            /// @src 4:26,1147
            constructor_IUniswapV2Pair_1726()
        ...
        function constructor_UniswapV2Pair_1046() {

            /// @src 1:2300,2358
            constructor_UniswapV2ERC20_1438()
            /// @src 1:1202,1203
            let expr_61 := 0x01
            update_storage_value_offset_0t_rational_1_by_1_to_t_uint256(0x0c, expr_61)

            /// @src 1:2341,2351
            let expr_152 := caller()
            /// @src 1:2331,2351
            update_storage_value_offset_0t_address_to_t_address(0x05, expr_152)
